export interface Match {
  ...
  teamA: { name: string; rank: number; abbr: string };
  teamB: { name: string; rank: number; abbr: string };
...
export const MOCK_MATCHES: Match[] = [
  {
    ...
    teamA: { name: 'Natus Vincere', rank: 3, abbr: 'NAVI' },
    teamB: { name: 'FaZe Clan', rank: 7, abbr: 'FAZE' },
  ...
  },
  {
    ...
    teamA: { name: 'G2 Esports', rank: 2, abbr: 'G2' },
    teamB: { name: 'Vitality', rank: 1, abbr: 'VIT' },
  ...
  },
  {
    ...
    teamA: { name: 'Team Spirit', rank: 4, abbr: 'SPR' },
    teamB: { name: 'MOUZ', rank: 5, abbr: 'MOUZ' },
  ...
  },
  {
    ...
    teamA: { name: 'Cloud9', rank: 9, abbr: 'C9' },
    teamB: { name: 'Heroic', rank: 11, abbr: 'HRC' },
  ...
  },
  {
    ...
    teamA: { name: 'Liquid', rank: 6, abbr: 'TL' },
    teamB: { name: 'Complexity', rank: 14, abbr: 'COL' },
  ...
  },
  {
    ...
    teamA: { name: 'Astralis', rank: 8, abbr: 'AST' },
    teamB: { name: 'ENCE', rank: 12, abbr: 'ENCE' },
  ...
  },
  {
    ...
    teamA: { name: 'Natus Vincere', rank: 3, abbr: 'NAVI' },
    teamB: { name: 'Team Spirit', rank: 4, abbr: 'SPR' },
