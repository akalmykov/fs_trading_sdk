...
export async function queryMarketState(
  ...
  const alphaVector: number[] | undefined = data.alpha_vector ?? data.state_vector;
  if (alphaVector == null) throw new Error('Missing alpha_vector/state_vector in market response');
